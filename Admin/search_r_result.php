		...
		?>
              ...
              <tr bgcolor="<?php echo $bgcolor; ?>">
			   <td nowrap="nowrap" bgcolor="#BEED9E"><?php echo $hidden_pcourse; ?>&nbsp;&nbsp;&nbsp;</td>
                ...
                <td><a href="sched_r_del.php?sched_id=<?php echo $sched_id; ?>&pRoom=<?php echo $pRoom; ?>&pSy=<?php echo $pSy; ?>&psem=<?php echo $psem; ?>"> <img src='../images/b_drop.png' alt="delete record" width="16" height="16" border="0" onclick="return confirm('<?php echo "Are you sure you want to delete file #". $sched_id. "?"; ?>');" /></a></td>
              </tr>
              <?php 	
			$i++;		
			}
